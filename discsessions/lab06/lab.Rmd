...
date: |
    | \large\textbf{Lab 06 | R Graphs II}
fontsize: 12pt
output:
  beamer_presentation:
    highlight: tango
...
\vspace{.1cm}
    + Just start slow and progress. Understand trumps memorization!
\vspace{-1cm}
...
* Learning how to code is to learn how to speak a very formal language. As with learning any language, **practice makes it perfect**!

# Learning your R Studio

## R and RStudio
- In Lab 01, you should have installed two programs in your computer: 
...
\vspace{.2cm}
    ...
    \vspace{.1cm}
        ...
        + \fu{minutes=30} changes duration of bake to 30 minutes
