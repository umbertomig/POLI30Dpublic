...
- In the US, we try to collect data from each individual every ten years
    + The 2020 census cost \$14.2 billion, approximately (population at that time was around 331 million)
...
## Representative Samples
- Are you a representative sample of U.S. residents?
\vspace{.2cm}
...
- For the purpose of this class, we assume that we are always studying a representative sample.
...
- The position of the bins along the x-axis indicate a value
\vspace{.2cm}

- The height of the bins indicate the frequency (or count) of the values
\vspace{.2cm}
...
- The \concept{descriptive statistics}\ of a variable numerically summarize the main characteristics of its distribution
\vspace{.5cm}
...
\begin{mdframed}[backgroundcolor=white,linecolor=concept, linewidth=0.05cm]
\begin{center} 
The \concept{standard deviation}\ of a variable measures the average distance of the observations to the mean.
\end{center}
\end{mdframed}
\vspace{.2cm}
...
- If \textit{birth} were normally distributed, about 95\% of the register voters would have been born between 1927 and 1985:
